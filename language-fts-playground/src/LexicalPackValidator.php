...
final class Language_FTS_Playground_Lexical_Pack_Validator
{
    ...
    private function validate_language_directory(string $directory_id, string $directory): array
    {
        ...
        if (isset($resource_paths['synonyms'])) {
            $pairwise = $this->validate_pairwise_synonyms($resource_paths['synonyms'], $warnings, $single_token_expansion_targets);
        ...
        if (isset($resource_paths['synsets'])) {
            $synsets = $this->validate_synsets($resource_paths['synsets'], $warnings, $single_token_expansion_targets);
        ...
        if (isset($resource_paths['synonym_phrases'])) {
            $phrase_synonyms = $this->validate_synonym_phrases($resource_paths['synonym_phrases'], $warnings, $phrase_expansion_targets);
