...
test_case('quality release evidence collector runs Docker lifecycle smokes only with explicit opt-in', function (): void {
    ...
    wp_fts_release_evidence_contract_same(true, $optInDetails['uninstall_table_cleanup'] ?? null, 'Docker lifecycle lane should require current/reset-generation uninstall cleanup');
