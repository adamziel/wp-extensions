...
function wp_fts_tslr_cases(): array
{
    return [
        ...
        [
            'id' => 'ar-snowball-official-verb-pronoun',
            'lang' => 'ar',
            'target_id' => 1010,
            'bait_id' => 2010,
            'target' => 'أأباحتاهم مفيدة للبحث',
            'query' => 'اباح بحث',
            'bait_lang' => 'fa',
            'bait' => 'فارسی جستجو أأباحتاهم للبحث',
        ],
        [
            'id' => 'ar-snowball-official-prefix-suffix',
            'lang' => 'ar',
            'target_id' => 1011,
            'bait_id' => 2011,
            'target' => 'أأوقفتموهما بصنوكم واضحة',
            'query' => 'اقف بصن',
            'bait_lang' => 'fa',
            'bait' => 'فارسی جستجو أأوقفتموهما بصنوكم',
        ],
        [
            'id' => 'fr-snowball-infinitive-imperfect',
            'lang' => 'fr',
            'target_id' => 1012,
            'bait_id' => 2012,
            'target' => 'Les enfants mangeaient rapidement.',
            'query' => 'manger',
            'bait_lang' => 'en',
            'bait' => 'manger mangeaient',
        ],
        [
            'id' => 'fr-snowball-plural',
            'lang' => 'fr',
            'target_id' => 1013,
            'bait_id' => 2013,
        ...
        [
            'id' => 'bn-classifier-dative-genitive-baseline',
            'lang' => 'bn',
            'target_id' => 1029,
            'bait_id' => 2029,
            'target' => 'বইটিকে তাকের ওপর রাখা হয়েছে',
            'query' => 'বই তাক',
            'bait_lang' => 'bn',
            'bait' => 'বাংলা অনুসন্ধান পাঠ',
        ],
        [
            'id' => 'bn-human-plural-dative-baseline',
            'lang' => 'bn',
            'target_id' => 1030,
            'bait_id' => 2030,
            'target' => 'শিক্ষকদেরকে বিদ্যালয়ের সূচিতে রাখা হয়েছে',
            'query' => 'শিক্ষক বিদ্যালয় সূচি',
            'bait_lang' => 'bn',
            'bait' => 'শহর নদী বাংলা পাঠ',
        ],
        [
        ...
        [
            'id' => 'ur-feminine-direct-oblique-baseline',
            'lang' => 'ur',
            'target_id' => 1031,
            'bait_id' => 2031,
            'target' => 'لڑکیوں کی کتابیں موجود ہیں',
            'query' => 'لڑکیاں کتاب',
            'bait_lang' => 'ur',
            'bait' => 'اردو تلاش فہرست',
        ],
        [
            'id' => 'ur-masculine-oblique-baseline',
            'lang' => 'ur',
            'target_id' => 1032,
            'bait_id' => 2032,
            'target' => 'لڑکوں کے استادوں کی فہرست موجود ہے',
            'query' => 'لڑکے استاد فہرست',
            'bait_lang' => 'ur',
            'bait' => 'اردو تلاش واضح متن',
        ],
        [
            'id' => 'ur-arabic-loan-plural-at-baseline',
            'lang' => 'ur',
            'target_id' => 1033,
            'bait_id' => 2033,
            'target' => 'حالات اور معلومات واضح ہیں',
            'query' => 'حال معلوم',
            'bait_lang' => 'ur',
            'bait' => 'حیات زکات اردو متن',
        ],
        [
