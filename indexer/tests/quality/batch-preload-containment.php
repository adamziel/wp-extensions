    ...
    try {
        foreach ($cases as $label => $case) {
            ...
            if ($case['wpml']) {
                ...
                assert_contains("wpml_translation.element_type = CONCAT('post_', wpml_post.post_type)", $sql, "{$label} should probe the exact canonical WPML element type without a LIKE range");
