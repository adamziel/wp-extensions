...
function wp_fts_schema_repair_schema(): array
{
    return [
        ...
        'CREATE INDEX IF NOT EXISTS wp_fts_post_term ON wp_fts_postings(post_id,term_id)',
        ...
        'CREATE INDEX IF NOT EXISTS wp_fts_document_presence ON wp_fts_documents(post_id,indexed_at)',
