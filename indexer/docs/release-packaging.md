...
Snowball/Porter2 and bundled Spanish Snowball stemming remain available without
Composer; missing vendor dependencies only make the Snowball harness skip
